...
- **Last Milestone**: Vector Context Research / Investigación de Contexto Vectorial
- **Current Version**: 1.1.0-alpha

---

## Branch Map / Mapa de Ramas
- `master`: Main production-ready standard.
- `feature/vector-context-research`: Research and implementation of RAG/Vector support (Merged into master).
